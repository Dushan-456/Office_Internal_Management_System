        ...
        <Box className="w-full lg:w-[380px] xl:w-[420px] lg:sticky top-24 z-10 shrink-0">
          ...
          >
            <Paper className="glass-card rounded-[3rem] text-center relative pb-5 overflow-hidden flex flex-col items-center">
              ...
              <Stack spacing={3} className="text-left w-full px-8 mt-6">
                <Box className="flex items-center gap-4">
              ...
              {isAdmin && (
                <Box className="mt-4 px-5 w-full space-y-3">
                  ...
                  >
                    {resetLoading ? <CircularProgress size={20} color="inherit" /> : resetSent ? 'Password Recovery Sent!' : 'Send Recovery Link'}
                  </Button>
                </Box>
              )}
            </Paper>
